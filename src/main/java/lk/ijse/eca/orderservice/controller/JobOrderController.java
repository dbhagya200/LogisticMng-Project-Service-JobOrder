...
public class JobOrderController {
    ...
    public ResponseEntity<JobOrderDto> createJobOrder(
        ...
        log.info("POST /api/v1/job - customerNic: {}", dto.getCustomerNic());
    ...
    public ResponseEntity<List<JobOrderDto>> getJobOrdersByCustomerNic(
        ...
        log.info("GET /api/v1/job?customerNic={} - retrieving jobOrders by customer", customerNic);
